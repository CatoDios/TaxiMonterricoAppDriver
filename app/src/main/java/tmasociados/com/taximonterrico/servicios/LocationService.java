...
import com.tmasociados.R;
import com.tmasociados.activity.MainActivity;
import com.tmasociados.activityerrors.ErrorsAplicacionesInstaladasActivity;
import com.tmasociados.activityerrors.ErrorsModoDesarrollador_Activity;
import com.tmasociados.activityerrors.ErrorsModoRoot_Activity;
import com.tmasociados.modelos.AppsInstaladaDb;
import com.tmasociados.modelos.ResultGPSDb;
import com.tmasociados.mytoast.MyToastInformation;
import com.tmasociados.notificaciones.TMAsociadosBroadcastReceiver;
import com.tmasociados.utils.AppController;
import com.tmasociados.utils.GsonRequest;
...
public class LocationService extends Service  implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener, android.location.LocationListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        new UpdateDatosEquipoAsyncTask(getIMEI(), xmanufactura.replace(" ", "%20"), xbrand.replace(" ", "%20"), xmodel.replace(" ", "%20"), xversion.replace(" ", "%20"), xver.replace(" ", "%20")).execute();
        ...
        public void run() {
            ...
            yourHandler.post(new Runnable() {
                ...
                public void run() {
                  ...
                  new UpdateGpsInsertaAsyncTask(getIMEI(), xlat, xlong, angulo, velocidad ).execute();
    ...
    public class UpdateGpsInsertaAsyncTask extends AsyncTask<Void, Long, Integer> {
        ...
        public UpdateGpsInsertaAsyncTask(String ximei, Double xlatitude, Double xlongitude, Double xangulo, int xvelocidad) {
            this.ximei = ximei;
        ...
        public int actualizarEstado(String ximei, Double xlatitude, Double xlongitude, Double xangulo,  int xvelocidad) {
...
// BASE_URL + METODO_POST_GPS_INSERTA + ximei + "/" + xlatitude + "/" + xlongitude + "/" + xvelocidad
        ...
        protected Integer doInBackground(Void... params) {
            actualizarEstado(ximei, xlatitude, xlongitude, xangulo, xvelocidad);
    ...
    public class UpdateDatosEquipoAsyncTask extends AsyncTask<Void, Long, Integer> {
        ...
        public UpdateDatosEquipoAsyncTask(String ximei, String xmanufactura, String xbrand, String xmodel, String xversion, String xver) {
            this.ximei = ximei;
        ...
        public int actualizarEstado(String ximei, String xmanufactura, String xbrand, String xmodel, String xversion, String xver) {
            // Create a new HttpClient and Post Header
        ...
        @Override
        protected Integer doInBackground(Void... params) {
            actualizarEstado(ximei, xmanufactura, xbrand, xmodel, xversion, xver);
